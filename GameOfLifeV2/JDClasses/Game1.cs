...
namespace JeuDeLaVie
{
    ...
    public class Game1 : Game
    {
        ...
        protected internal int staleWaitTime = 500, windowSizeX = 1920, windowSizeY = 1080, physicalMaxFPS = 60;
        private Texture2D plusButtonTexture, minusButtonTexture;
        ...
        protected void DrawThread()
        {
            ...
            spriteBatch.Draw(texture: tableTexture, position: new Vector2(0, 0), color: Color.White);
            ...
            if (sideMenuEtMouseFollowUp)
            {
                if (structureHover)
                {
                    spriteBatch.Draw(texture: structureTexture, position: new Vector2(newState.X - selectedStructure.getWidth(arrowDirection) / 2, newState.Y - selectedStructure.getHeight(arrowDirection) / 2), color: Color.White);
                }

                spriteBatch.Draw(texture: menuTexture, position: new Vector2(windowSizeX, 0), color: Color.White);
                spriteBatch.Draw(texture: arrowTexture, position: new Vector2(windowSizeXPlus12, menuHeightMinus30), color: Color.White);
                spriteBatch.Draw(texture: plusButtonTexture, position: new Vector2(windowSizeXPlus4, 112), color: Color.White);
                spriteBatch.Draw(texture: minusButtonTexture, position: new Vector2(windowSizeXPlus27, 112), color: Color.White);
